 ...
 *
 * Created by gusbocju@student.gu.se on 2018-03-06.
 *  Edited by Leo Persson -> Added frame for Internal to External comms to V2VService, PS4 and LeaderStatus implementation, Command line argument implementation from Anthony Path's work
 *  Edited by Fahd Debbiche -> Added Timed turning function for follower
 *
 */
