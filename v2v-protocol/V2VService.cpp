    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 5: while(1){
                        ...
                        cluon::OD4Session od4(240,[&angle, &speed](cluon::data::Envelope &&envelope) noexcept {
...
V2VService::V2VService() {
    ...
    view = 
        std::make_shared<cluon::OD4Session>(INTERNAL_CHANNEL, [](cluon::data::Envelope &&/*envelope*/) noexcept {});
