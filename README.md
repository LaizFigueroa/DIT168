...
```
### Running the tests
Automated tests: There will be automated tests generated by Travis working hand-in-hand with the production code, available on: https://travis-ci.org/LaizFigueroa/DIT168.svg?branch=master.
